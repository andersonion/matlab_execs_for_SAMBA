...
function save_nii_hdr(hdr, fid)
   ...
   if hdr.hist.qform_code == 0 & hdr.hist.sform_code == 0
      ...
      hdr.hist.srow_x(4) = (1-double(hdr.hist.originator(1)))*hdr.dime.pixdim(2);
      hdr.hist.srow_y(4) = (1-double(hdr.hist.originator(2)))*hdr.dime.pixdim(3);
      hdr.hist.srow_z(4) = (1-double(hdr.hist.originator(3)))*hdr.dime.pixdim(4);
   end
